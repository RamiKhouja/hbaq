  ...
  return (
    <section className="mx-auto max-w-7xl xl:max-w-screen-2xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="overflow-hidden rounded-[2rem] bg-[#fff2d9] p-6 shadow-sm sm:p-8">
            ...
            <Link href="/gift-packs/build-your-own" className="mt-6 block w-full rounded-full bg-secondark px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-green-700 sm:inline-block sm:w-auto">
        ...
        <div className="overflow-hidden rounded-[2rem] bg-[#e7f8e5] p-6 shadow-sm sm:p-8">
            ...
            <Link href="/shop" className="mt-6 block w-full rounded-full bg-primary px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-green-700 sm:inline-block sm:w-auto">
              {t('homepage.deals.learn_more')}
            </Link>
            {/* <Link href="/shop" className="mt-6 w-full rounded-full bg-green-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-900 sm:w-auto">
              {t('homepage.deals.learn_more')}
            </Link> */}
        </div>
        </div>
